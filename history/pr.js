...
function creatBox() {
    for (i = 0; i < historyList.length; i++) {
        ...
        $(prIndex).append('<div class="event"><div class="time"><span><i class="year">' + date[0] + '.</i><i class="month">' + date[1] + '</i>.' + date[2] + '</span></div><div class="affair"><div><p>' + listOne[1] + '</p><p>' + listOne[2] + '</p></div></div></div>');
    };
};
